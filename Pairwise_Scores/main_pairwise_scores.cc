...
#include "main_pairwise_scores_options.h"
...
{
    main_pairwise_scores_options options(argc,argv);
    ...
    pairwise_scores sampler(input_pdb_files, calpha_template_file, labels,
