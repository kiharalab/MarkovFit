...
public:
    ...
    mrf_two_body_features()
    {
        alpha_z_left = beta_y_left = gamma_x_left = translate_x_left = translate_y_left = translate_z_left = alpha_z_right = beta_y_right = gamma_x_right = translate_x_right = translate_y_right = translate_z_right =rmsd = no_clashes = 0;
        label_left = label_right = "X";
        
        physics_score = soroban_score();
    }
